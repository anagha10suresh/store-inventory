...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // If form is submitted, update or insert data
...
// Fetch data for editing if GIRNo is provided in the URL
if (isset($_GET['GIRNo'])) {
    $GIRNo = $_GET['GIRNo'];

    $sql = "SELECT * FROM machinery WHERE GIRNo='$GIRNo'";
...
<head>
    ...
    <title>Edit Machinery Entry</title>
    <style>
        /* General Styling */
        body {
    font-family:cambria;
