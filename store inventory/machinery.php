...
<a href="javascript:void(0);" class="icon toggle-btn" onclick="toggleNav()">
    ...
    <center><h2>WELCOME TO DSR-A (MACHINERY & EQUIPMENTS)</h2>
    <a href="machineryform.php"><button>Add Machinery</button></a></center>
    <br>
    <br>

    <!-- Display existing machinery data in a table -->
    <table border="1">
        <thead>
            <tr>
                <th>GIR No.</th>
                ...
                <th>Balance</th>
                <th>Action</th> 
                <th>Image</th> <!-- Add a table header for the Edit button -->
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    // Add an Edit button for each row, linking to machineryedit.php and passing the GIRNo as a parameter
                    ...
                    echo "<td><a class='edit' href='machinery_entry.php?GIRNo=".$row["GIRNo"]."'>Edit</a></td>";
                    echo "</tr>";
                }
            } else {
