...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO strive (GIRNo, Date, SupplierName, SlNo, Description, Quantity, EachRupees, TotalRupees, IndentSlNo, IndentNo, IndentDate, IndentingOfficialName, LabSection, Received, Issued, Balance, ImageFilePath) 
...
<a href="javascript:void(0);" class="icon toggle-btn" onclick="toggleNav()">
    ...
    <h1>Add Strive</h1>
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data"> <!-- Add enctype attribute for file upload -->
        <label for="GIRNo">GIR No.:</label><br>
        <input type="text" id="GIRNo" name="GIRNo"><br>
        ...
        <input type="text" id="SlNo" name="SlNo"><br>
        <label for="Description">Description of Stores:</label><br>
        <input type="text" id="Description" name="Description"><br>
        <label for="Quantity">Quantity:</label><br>
        <input type="text" id="Quantity" name="Quantity"><br>
        <label for="EachRupees">Each Rupees:</label><br>
        <input type="text" id="EachRupees" name="EachRupees"><br>
        <label for="TotalRupees">Total Rupees:</label><br>
        <input type="text" id="TotalRupees" name="TotalRupees"><br>
        <label for="IndentSlNo">Indent SlNo:</label><br>
        <input type="text" id="IndentSlNo" name="IndentSlNo"><br>
        <label for="IndentNo">Indent No.:</label><br>
        <input type="text" id="IndentNo" name="IndentNo"><br>
        <label for="IndentDate">Indent Date:</label><br>
        <input type="date" id="IndentDate" name="IndentDate"><br>
        <label for="IndentingOfficialName">Name of Indenting Official:</label><br>
        <input type="text" id="IndentingOfficialName" name="IndentingOfficialName"><br>
        <label for="LabSection">Lab Section:</label><br>
        <input type="text" id="LabSection" name="LabSection"><br>
        ...
        <input type="file" name="fileToUpload" id="fileToUpload"><br> <!-- File input field -->
        <input type="submit" name="submit" value="Submit"> <!-- Add name attribute to submit button -->
    </form>
    <script>
