...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    header("Location: consumables_entry.php");
    exit();
}
...
if(isset($_GET['GIRNo'])) {
    ...
    $sql = "SELECT * FROM consumables WHERE GIRNo='$GIRNo'";
...
<head>
    ...
    <title>Edit Consumables Entry</title>
    <style>
        /* General Styling */
        body {
    font-family:cambria;
