...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO consumables (GIRNo, Date, SupplierName, SlNo, Description, Quantity, EachRupees, TotalRupees, IndentSlNo, IndentNo, IndentDate, IndentingOfficialName, LabSection, Received, Issued, Balance, ImageFilePath) 
