...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($username === $valid_username && $password === $valid_password) {
        // If credentials are correct, continue with the editing process
        session_start();
        $_SESSION['loggedin'] = true;
        $_SESSION['GIRNo'] = $_GET['GIRNo']; // Store GIRNo in session
        header("Location: consumables_process.php?GIRNo=" . $_GET['GIRNo']); // Redirect to edit_consumable.php
        exit();
    } else {
