...
<a href="javascript:void(0);" class="icon toggle-btn" onclick="toggleNav()">
    ...
    <!-- Add a button to navigate to the form for adding new consumables -->
    <center><h2>WELCOME TO DSR-M (CONSUMABLES)</h2>
    <a href="consumablesform.php"><button>Add Consumables</button></a></center>
    <br>
    <br>
    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <!-- Add a table header for the Upload Image button -->
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>". $row["Received"]."</td>"; // Display Received values with line breaks
                    echo "<td>".$row["Issued"]."</td>"; // Display Issued values with line breaks
                    ...
                    // Add an Edit button for each row, linking to edit_consumable.php and passing the GIRNo as a parameter
                    echo "<td><a class='edit' href='consumables_entry.php?GIRNo=".$row["GIRNo"]."'>Edit</a></td>";
               
                    // Add a button for uploading an image, linking to upload_image.php and passing the GIRNo as a parameter
                    echo "</tr>";
                ...
                echo "<tr><td colspan='18'>No consumables records found</td></tr>";
            }
            $conn->close();
            ?>
        </tbody>
    ...
    <!-- Hidden form for uploading image -->
