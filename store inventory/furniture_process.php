...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    header("Location: furniture_entry.php");
    exit();
}
...
if(isset($_GET['GIRNo'])) {
    ...
    $sql = "SELECT * FROM furniture WHERE GIRNo='$GIRNo'";
...
<head>
    ...
    <title>Edit Furniture Entry</title>
    <style>
        /* General Styling */
        body {
    font-family:cambria;
