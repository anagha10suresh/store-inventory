...
<a href="javascript:void(0);" class="icon toggle-btn" onclick="toggleNav()">
    ...
    <center><h2>WELCOME TO DSR-F (FURNITURE)</h2></center>
    <!-- Add a button to navigate to the form -->
   <center> <a href="furnitureform.php"><button>Add Furniture</button></a><center><br>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a class='edit' href='furniture_entry.php?GIRNo=".$row["GIRNo"]."'>Edit</a></td>";
