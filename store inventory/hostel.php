...
<a href="javascript:void(0);" class="icon toggle-btn" onclick="toggleNav()">
    ...
    <center><h2>WELCOME TO DSR-H (HOSTEL)</h2>
    <a href="hostelform.php"><button>Add Hostel</button></a></center>
    <br>
    <br>
    
  <!-- Display existing hostel data in a table -->
    <table border="1">
        <thead>
            <tr>
                <th>GIR No.</th>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    // Add an Edit button for each row, linking to hostel_process.php and passing the GIRNo as a parameter
                    echo "<td><a class='edit' href='hostel_entry.php?GIRNo=".$row["GIRNo"]."'>Edit</a></td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='18'>No hostel records found</td></tr>";
            }
            $conn->close();
            ?>
        </tbody>
